...
public class CommonData {
    ...
    public static final int REQUEST_BIDDING_DETAIL = 204;//竞价单详情
    ...
    public static final int REQUEST_MONEY = 304;//提现
    ...
    public static final String INQUIRE_ID = "inquire_id";//id
    ...
    public static final int[] imgList = new int[]{R.drawable.icon_photo_tyre, R.drawable.icon_photo_engine, R.drawable.icon_photo_belt};
...
//            Date date_start = sDateFormat.parse(start_time);
    ...
    public void share(Activity activity, String id) {
        ...
        String shareContent = "哦了商家欢迎您，领取优惠礼包！" + url;
