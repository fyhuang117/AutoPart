...
//        mDrawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED);
        ...
        if (preferences.getIsLogin()) {//登录才能获取用户信息
...
//        mDrawerToggle.onConfigurationChanged(newConfig);
    ...
    private Class[] activitys = {UserMessageActivity.class, MenuUserWalletActivity.class, null, MenuSystemActivity.class};
...
//        args.putInt(SampleFragment.ARG_ACTION_BG_RES, R.drawable.ab_background);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.topBar_left_layout:
                ...
                break;
            case R.id.topBar_right_image_parent:
    ...
    public void user_info(View view) {
        Intent intent = new Intent(context, SellerUserInfoActivity.class);
        startActivity(intent);
    }
