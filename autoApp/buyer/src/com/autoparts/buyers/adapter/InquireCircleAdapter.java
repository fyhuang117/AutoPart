 ...
 * Created time:15-3-6
 */
public class InquireCircleAdapter extends BaseAdapter {
    ...
    public InquireCircleAdapter(Context context, Vector<HashMap<String, Object>> mList) {
        this.mList = mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.common_item_title.setText((String) mList.get(position).get("name"));
        return view;
    }
