 ...
 * Created time:15-3-5
 */
public class InquiryVoiceActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.inquiry_voice);
    ...
    private void init() {
        ...
        mRecordPath = getIntent().getStringExtra("path");
        if (!TextUtils.isEmpty(mRecordPath)) {
            ...
            mRecord_Time = mMediaPlayer.getDuration()/1000;
            Utils.showLog("mRecordPath=="+mRecordPath);
            Utils.showLog("mRecord_Time=="+mRecord_Time);
    ...
    public void commit(View view) {
        ...
        intent.putExtra("path", mRecordPath);
    ...
    private void setListener() {
        voive_image.setOnTouchListener(new View.OnTouchListener() {
            ...
            public void onClick(View v) {
                ...
                if (!mPlayState) {
                    ...
                    try {
                        ...
                        // 播放
                        mMediaPlayer.start();
                        mRecord_Time = mMediaPlayer.getDuration()/1000;//秒
                        mDisplayVoiceProgressBar.setMax((int) mRecord_Time);
                        mDisplayVoiceTime.setText((int) mRecord_Time + "″");
                        // 根据时间修改界面
                        new Thread(new Runnable() {
