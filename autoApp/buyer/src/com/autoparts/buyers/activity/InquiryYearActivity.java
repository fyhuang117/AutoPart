...
import com.autoparts.buyers.adapter.ExpandListViewAdapter;
import com.autoparts.buyers.adapter.YearListAdapter;
    ...
    public void setViewData(){
        ...
        expandListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, final int i, int i1, long l) {
                ...
                intent.putExtra(CommonData.INQUIRE_NAME,year +"款  "+name);
