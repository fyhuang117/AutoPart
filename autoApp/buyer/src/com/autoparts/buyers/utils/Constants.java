...
public class Constants {
    ...
    public static final int type = 0;//"type":"用户标识(0-买家1-卖家)"
    ...
    public static String USER_COUPON = HOST_URL + "usercoupon.php";//用户优惠券
    ...
    public static String ORDER_INQUIRE_DETAIL = HOST_URL + "inquiry.php";//询价单详情
    ...
    public static String ORDER_GET_STATE = HOST_URL + "orderstatussummaries.php";//根据订单状态 获取我的订单
    ...
    public static String SEARCH_PARTTYPE = HOST_URL + "searchparttype.php";//搜索配件
